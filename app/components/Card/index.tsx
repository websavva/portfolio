  ...
  setup(props, { slots }) {
    ...
    return () => (
      <div
        ...
        style={style.value}
        class={cn(
          'overflow-hidden p-6 sm:p-8 lg:p-12 relative rounded-2xl border border-editor-background-secondary transition-all hover:shadow-lg select-none hover:shadow-(color:--card-color)',
